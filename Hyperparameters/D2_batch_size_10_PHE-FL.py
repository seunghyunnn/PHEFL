...
def lambda_handler(result):
    result_file_name = 'D2_batch_size_10_PHE-FL.txt'
...
for i in range(NUM_OF_DEVICE):
    ...
    device_models[i].fit(edge_X_train_dataset[str(i // 10)][i%10], edge_Y_train_dataset[str(i // 10)][i%10],epochs=5,verbose=0, batch_size=10)
