...
def lambda_handler(result):
    result_file_name = 'D4_MNIST_imbalanced_EC-FL.txt'
...
for i in range(NUM_OF_EDGE):
    ...
    loss, accuracy = cloud_model.evaluate(edge_X, edge_Y, verbose=0)
